...
export class XRectColorPickerElement extends HTMLElement {
  ...
  constructor() {
    ...
    this["#satlight-slider"].addEventListener("pointerdown", (event) =>
      this._onSatlightSliderPointerDown(event)
    );
  ...
  _updateSatlightSliderBackground() {
    ...
    this[
      "#satlight-slider"
    ].style.background = `${background3}, ${background2}, ${background1}`;
  }
  ...
  _onSatlightSliderPointerDown(pointerDownEvent) {
    ...
    this["#satlight-slider"].addEventListener(
      "pointermove",
    ...
    this["#satlight-slider"].addEventListener(
      ...
      (lostPointerCaptureListener = (event) => {
        this["#satlight-slider"].removeEventListener(
          "pointermove",
          pointerMoveListener
        );
        this["#satlight-slider"].removeEventListener(
